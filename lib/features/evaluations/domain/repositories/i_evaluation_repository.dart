...
abstract class IEvaluationRepository {
  ...
  Future<void> submitScore({required String userId, required String evaluationId, required String courseID, required String evaluatorId, required String groupID, required String categoryID, required Score scores});
